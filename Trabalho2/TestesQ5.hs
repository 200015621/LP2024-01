module TestesQ5 where

import Q5.AbsLI
import Q5.Interpreter
...
main = do
  putStrLn
    (   "Suite de Testes do Trabalho 02, Exercício 4"
        ++ "\nO teste do primeiro programa deve retornar True:\t"
        ++ show testCase1
        ++ "\nO teste do segundo programa deve retornar True:\t"
        ++ show testCase2 
        ++ "\nO teste do terceiro programa deve retornar True:\t"
        ++ show testCase3 
        ++ "\nO teste do quarto programa deve retornar True:\t"
        ++ show testCase4 
        ++ "\nO teste do quinto programa deve retornar True:\t"
        ++ show testCase5 
        ++ "\nO teste do sexto programa deve retornar True:\t"
        ++ show testCase6 
        ++ "\nO teste do setimo programa deve retornar True:\t"
        ++ show testCase7 
        ++ "\nO teste do oitavo programa deve retornar True:\t"
        ++ show testCase8 
        ++ "\nO teste do nono programa deve retornar True:\t"
        ++ show testCase9 
        ++ "\nO teste do décimo programa deve retornar True:\t"
        ++ show testCase10 
    )
