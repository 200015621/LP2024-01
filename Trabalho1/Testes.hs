...
main = do
  putStrLn
    (   "Suite de Testes do Trabalho 01"
        ++ "\nO resultado global dos testes do exercício 1 deve 'True':\t"
        ++ show testeExercicio1
        ++ "\nO resultado global dos testes do exercício 2 deve 'True':\t"
        ++ show testeExercicio2 
        ++ "\nO resultado global dos testes do exercício 3 deve 'True':\t"
        ++ show testeExercicio3 
        ++ "\nO resultado global dos testes do exercício 4 deve 'True'\t"
        ++ show testeExercicio4 
        ++ "\nO resultado global dos testes do exercício 5.1 deve 'True':\t"
        ++ show testeExercicio5a
        ++ "\nO resultado global dos testes do exercício 5.2 deve 'True':\t"
        ++ show testeExercicio5b 
        ++ "\nO resultado global dos testes do exercício 6 deve 'True':\t"
        ++ show testeExercicio6 
        ++ "\nO resultado global dos testes do exercício 7 deve 'True':\t"
        ++ show testeExercicio7 
        ++ "\nO resultado global dos testes do exercício 8 deve 'True':\t"
        ++ show testeExercicio8 
        ++ "\nO resultado global dos testes do exercício 9 deve 'True':\t"
        ++ show testeExercicio9 
        ++ "\nO resultado global dos testes do exercício 10 deve 'True':\t"
        ++ show testeExercicio10 
        ++ "\nO resultado global dos testes do exercício 11 deve 'True':\t"
        ++ show testeExercicio11 
    )
